...
import com.track.myapplication.data.local.LogInRoutes
...
import com.track.myapplication.ui.screens.navigation.NavigationScreen
import com.track.myapplication.ui.screens.registration.RegistrationScreen
        ...
        Surface(
            ...
            NavHost(
                ...
                composable(route = LogInRoutes.Login.name) {
                    LogInInterface(
                        viewModel = viewModel,
                        onSignUpClicked = { navController.navigate(LogInRoutes.Registration.name) },
                        onLogInSuccessful = {
